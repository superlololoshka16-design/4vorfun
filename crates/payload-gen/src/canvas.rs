...
pub fn canvas_hash(seed: u64, vendor: &str, renderer: &str) -> [u8; 32] {
    ...
    let h = xxh3_seeded(0x5349_4C4F_4341_4E56, buf.as_slice());
    let mut pre = [0u8; 8];
...
pub fn webgl_param(seed: u64, slot: u8) -> f64 {
    ...
    let bits =
        xxh3_seeded(0x5745_4247_4C53_4C4F, &seed.to_le_bytes()).rotate_left((slot as u32) * 7);
